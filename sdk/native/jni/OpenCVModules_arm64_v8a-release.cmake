...
# Import target "opencv_libgperf" for configuration "Release"
set_property(TARGET opencv_libgperf APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
set_target_properties(opencv_libgperf PROPERTIES
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "dl;m;log;tbb;jnigraphics"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_libgperf.so"
  IMPORTED_SONAME_RELEASE "libopencv_libgperf.so"
  )

list(APPEND _IMPORT_CHECK_TARGETS opencv_libgperf )
list(APPEND _IMPORT_CHECK_FILES_FOR_opencv_libgperf "${_IMPORT_PREFIX}/sdk/native/libs/arm64-v8a/libopencv_libgperf.so" )
